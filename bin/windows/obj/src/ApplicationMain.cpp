...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("MyApplication",24,d3,d1,1c),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("My Company",89,30,89,01));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("MyApplication",24,d3,d1,1c));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TheApp",d0,e4,9a,ba));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.TheApp",21,92,b8,a4));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TheApp",d0,e4,9a,ba))
